  ...
  private void configureBindings() {
    ...
    CommandScheduler.getInstance().setDefaultCommand(drivetrain, 
      new DriverControl(drivetrain, 
        ()-> deadbander.applyLinearScaledDeadband(-mDriver.getLeftY(), 0.01) * 3, 
        ()-> deadbander.applyLinearScaledDeadband(-mDriver.getLeftX(), 0.01) * 3 , 
        ()-> deadbander.applyLinearScaledDeadband(-mDriver.getRightX(), 0.01) * 3 , 
        true));
