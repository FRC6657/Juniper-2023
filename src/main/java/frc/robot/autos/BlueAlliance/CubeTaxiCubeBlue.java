...
public class CubeTaxiCubeBlue extends SequentialCommandGroup {
    ...
    public CubeTaxiCubeBlue(Drivetrain drivetrain, Pivot pivot, Arm arm, Pistons pistons, Claw claw) {
        addCommands(
